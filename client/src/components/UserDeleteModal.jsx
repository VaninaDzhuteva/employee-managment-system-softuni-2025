export default function UserDeleteModal({onClose, userId, forceUserRefresh}) {
        ...
        <div class="overlay">
            ...
            <div class="modal">
                <div class="confirm-container">
                    ...
                    <div class="actions">
                        <div id="form-actions">
                            <button id="action-save" class="btn" type="submit" onClick={deleteUserHandler}>Delete</button>
